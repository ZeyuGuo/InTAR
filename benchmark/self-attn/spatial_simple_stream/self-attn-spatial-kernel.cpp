...
#pragma HLS ARRAY_PARTITION variable = result dim = 0 complete
#pragma HLS ARRAY_PARTITION variable = input_col dim = 0 complete
#pragma HLS ARRAY_PARTITION variable = weight_row dim = 0 complete
